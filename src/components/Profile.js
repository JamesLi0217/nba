...
class Profile extends React.Component {
    render() {
        const {
            ...
            weight,
            playerId,
            pts, reb, ast, pie,firstName,lastName, teamCode
        } = this.props.playerInfo;
        console.log(this.props.playerInfo)
        return (
            <div className="profile">
                <a href = {`https://www.nba.com/players/${firstName}/${lastName}/${playerId}` } target="_blank">
                ...
                <img
                    ...
                    alt="Profile"
                /></a>
                <a href = {`https://www.nba.com/teams/${teamCode}`} target="_blank">
